...
it('rejects model with empty alphabet', () => {
    ...
    let initial = "0";
    let accepting = "3";
    let allStates = "0,1,2,3";
    let alphabet = "";
    let transitions = "(a,0,1);(a,0,2);(b,1,1); (eps,1,2);(b,2,2);(a,2,3)";
    let test = new NFAModel(initial, accepting, allStates, alphabet, transitions);
...
it('accepts sample string 1 for test model 2', () => {
    ...
    let initial = "q0";
    let accepting = "q6";
    let allStates = "q0,q1,q2,q3,q4,q5,q6";
    let alphabet = "0,1";
